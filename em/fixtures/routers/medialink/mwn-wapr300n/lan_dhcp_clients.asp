...
def_DHS = "192.168.1.100";
def_DHE = "192.168.1.200";
def_LEASE = "86400";
addCfg("DHS",1,def_DHS);
addCfg("DHE",3,def_DHE);
var dhcpList=new Array(';192.168.1.100;28:EF:01:2B:89:A4;0;85803','Andrews-iPad;192.168.1.112;1C:E6:2B:A7:8F:14;0;86116','android-951c82b7396fc6f7;192.168.1.110;A0:F4:50:11:E1:74;0;86254','android_1aa0643d1595227c;192.168.1.101;10:F9:6F:CD:97:0E;0;86369','Wii;192.168.1.103;00:23:31:6B:A9:89;0;86392');
var StaticList = new Array();
var ipmaceninit = "";
def_LANIP = "192.168.1.1";
			...
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
              <tr>
				...
				<form name="frmSetup" id="frmSetup" method="POST" action="/goform/DhcpListClient">
					...
					<input type=hidden name=GO value=lan_dhcp_clients.asp >
					<table cellpadding="0" cellspacing="0" class="content1">
							<tr>
								<td colspan="3" bgcolor="#9D9D9D" align="left">&nbsp;&nbsp;<b> <script>document.write(_("Static Assignment"));</script></b></td>
							</tr>
					</table>
					...
					<table cellpadding="0" cellspacing="0" class="content3" id="table1">
							<tr>
							  <td width="100" align="right" class="item1"><script>document.write(_("IP Address"));</script></td>
								<td class="value1" nowrap colspan="2" align="left">
									&nbsp;&nbsp;&nbsp;&nbsp;<SCRIPT>		
							...
							<tr>
							  <td width="100" align="right" class="item1"><script>document.write(_("MAC address"));</script></td>
								...
								<td align=right>
									<input type="button" class="button2"  value="" id="Add" onClick="add_static(IP,combinMAC2(MAC));">
								</td>
							</tr>
						</table>
						...
						<table cellpadding="0" cellspacing="0" class="content1">
							<tr>
								<td align="right">
									<input id="Refresh" type="button" class="button2" value=""  onclick='refresh("lan_dhcp_clients.asp")'>
								</td>
							</tr>
						</table>
