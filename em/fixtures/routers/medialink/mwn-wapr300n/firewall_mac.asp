...
var tmp="";
//var firewall_sta = "1"; //weige add
addCfg("check_en",40,"1");
addCfg("curNum",72,"2");
addCfg("ML1",60,'00:15:AF:E6:6B:DA,0-6,0-0,on,Netbook');
addCfg("ML2",61,'3A:DC:B1:09:21:4C,1-5,30600-74700,on,Sample');
addCfg("ML3",62,'');
addCfg("ML4",63,'');
addCfg("ML5",64,'');
addCfg("ML6",65,'');
...
/*	else if(firewall_sta == 1){
		alert("If you want to modify this page, please choose the firewall enable!");
		f.filter_mode.options.selectedIndex=0;
		document.getElementById("enableTab").style.display="none";
	}
*/	else{
...
function preSubmit(f)
{
	...
	loc += "&curNum=" + num; 
	   if (mac=="") { alert(_("Please enter a valid MAC Address.")); return }
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
          <tr>
			...
			<form name=frmSetup id="frmSetup" method=POST action=/goform/SafeMacFilter>
				...
				<tr><td height="30" colspan=7 align="left"><script>document.write(_("Filter Mode"));</script> :&nbsp;
				<script>
				...
				<tr><td height="30" align="right"><script>document.write(_("Enable"));</script>:</td>
				  <td height="30" align="left">&nbsp;&nbsp;&nbsp;&nbsp;
				  <input type="checkbox" id="en" onClick="onSelected()">&nbsp;&nbsp;&nbsp;&nbsp;<script>document.write(_("Clear this item"));</script>:<input type="button" class="button2" id="delbtn" value=""  onClick="onDel(document.frmSetup)"></td>
				</tr>
				</table>
